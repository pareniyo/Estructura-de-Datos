...
main:
    ...
    lw $t0, const_a       # Cargar constante A = 3
    lw $t1, const_b       # Cargar constante B 0 5
    lw $t2, tamano        # Cargar el tamaño del vector = 8
    li $t3, 0             # �?ndice i = 0
...
loop:
    ...
    # LINEA MOVIDA entre lw y mul (evita stall load-use)
    ...
    addi $t3, $t3, 1      # i = i + 1
    # --- Condición de salida ---
    beq $t3, $t2, loop    # Si i < 8, repertir
